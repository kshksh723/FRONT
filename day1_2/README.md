...
| `<cite>`   | 웹 문서나 포스트에서 참고 내용을 표시합니다.                               | `<p>내가 경험한 가장 흥미진진한 일은 누군가를 만나는 일이다 - 영화, <cite>‘비포선셋’</cite></p>` |
| `<code>`   | 컴퓨터 인식을 위한 소스 코드입니다.                                       | `<code>function saveTheLocal()</code>`                              |
| `<small>`  | 부가 정보를 작게 표시해도 되는 텍스트입니다.                                | `<p>가격: 13,000원 <small>(부가세 별도)</small><p>`                   |
